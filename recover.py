...
c.squid_right.draw_squid(c.track, c.gap, [4*c.track, c.track], c.track, c.gap, iTrackSquid=c.squid_track, iTrackJ=c.squid_track/2,  Lj_down=c.Lj_down, Lj_up=c.Lj_up, typePump='down', iSlopePump=0.25)

c.set_variable('offsetX_squid_left', '5mm')
c.set_variable('offsetY_squid_left', '3mm')
c.key_elt('squid_left', [c.chip_width-c.offsetX_squid_left, c.offsetY_squid_left], [-1,0])
c.squid_left.draw_squid(c.track, c.gap, [4*c.track, c.track], c.track, c.gap, iTrackSquid=c.squid_track, iTrackJ=c.squid_track/2,  Lj_down=c.Lj_down, Lj_up=c.Lj_up, typePump='up', iSlopePump=0.25)


c.set_variable('length_right', '4.5mm')
c.set_variable('length_left', '3.5mm')
