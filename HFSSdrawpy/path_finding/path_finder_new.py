...
class Path(object):
    def __init__(self, name, port_in, port_out, fillet, points=None, is_slanted=False,
                 mid=0.5, first=0, last=0):
        self.name = name
        self.port_in = port_in
        self.port_out = port_out
        self.fillet = fillet
        if points is None:
            self.points, self.is_slanted = find_path(port_in.pos, port_in.ori, 
    ...
    def __add__(self, other):
        ...
        if self.points[-1] == other.points[0]:
            ...
            return Path(
                ...
                self.fillet,
                points=points,
                is_slanted=self.is_slanted or other.is_slanted,
            )
