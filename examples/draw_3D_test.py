...
chip1 = Body(pm, 'chip1', rel_coor=[[0, 0, 0], [
             0, 1, 0], [1, 0, 0]], ref_name='chip')

chip2 = Body(pm, 'chip2', rel_coor=[[0, 0, 0], [
             1, 0, 0], [0, 0, 1]], ref_name='chip')
...
chip1.draw_cable(con_port1, port13, is_bond=True, fillet='100um',
