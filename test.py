...
#c.set_variable("capa_right_length", '300um')
#c.key_elt('capa_right', [c.chip_width-c.offsetX_capa_right, c.chip_length-c.offsetY_capa_right], [-1,0])
#c.capa_right.draw_inline_capa(c.track, c.gap, c.capa_right_spacing, c.capa_right_length, 5)
#
...
#c.set_variable("capa_left_length", c.capa_right_length)
#c.key_elt('capa_left', [c.chip_width-c.offsetX_capa_left, c.offsetY_capa_left], [-1,0])
#c.capa_left.draw_inline_capa(c.track, c.gap, c.capa_left_spacing, c.capa_left_length, 5)                                                 #nport
#
...
#
#c.set_variable('meander_length_right', '0.5mm')
#c.connect_elt('res1_right', 'capa_right_1', 'squid_right_2')
#c.res1_right.draw_cable(fillet=c.fillet, is_meander=True, to_meander=[1, 0, 5, 2, 6,  22, 2,  4, 1], meander_length=c.meander_length_right)
...
#
#c.set_variable('meander_length_left', '0.5mm')
...
#print(c.gapObjects)
#print(c.in_right)
c.subtract(c.ground_plane, 'in_right_track')
